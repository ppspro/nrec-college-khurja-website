...
const mdPath = path.join(__dirname, '../CLIENT_HANDOVER/Admin_User_Manual.md');

const mdContent = `# NREC College — Admin User Manual
...
![Homepage Content Editor](screenshots/homepage.png)
...
![Website Pages](screenshots/pages.png)
...
![Menu Manager](screenshots/menus.png)
...
![Departments Module](screenshots/departments.png)
...
![Courses Module](screenshots/courses.png)
...
![Faculty Module](screenshots/faculty.png)
...
![Curriculum Module](screenshots/curriculum.png)
...
![Events Module](screenshots/events.png)
...
![Downloads Module](screenshots/downloads.png)
...
![Website Settings](screenshots/settings.png)
...
![Help Center](screenshots/help.png)
...
console.log('Successfully generated Admin_User_Manual.md');
