...
export default function HeritageTemplate({ slug, sections }: HeritageTemplateProps) {
      ...
      <div className="bg-[#FDFBF7] border border-[#B8860B]/15 rounded-[32px] p-6 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.02)] space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 relative">
            ...
            <div className="text-gray-600 text-[15px] leading-relaxed font-light space-y-4">
              <p>
        ...
        {/* Main CMS Contents */}
        {sections.length > 0 && (
          <div className="bg-white border border-[#B8860B]/10 rounded-[24px] p-6 sm:p-10 shadow-sm">
  ...
  return (
    <div className="bg-[#FDFBF7] border border-[#B8860B]/15 rounded-[32px] p-6 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.02)] space-y-16">
      ...
      <div className="relative border-l-2 border-[#8B0E2A]/20 pl-8 space-y-12 max-w-4xl mx-auto py-4">
      ...
      {sections.length > 0 && (
        <div className="bg-white border border-gray-100 rounded-[24px] p-6 sm:p-10 shadow-sm">
          <CmsRenderer sections={sections} />
        </div>
      )}
