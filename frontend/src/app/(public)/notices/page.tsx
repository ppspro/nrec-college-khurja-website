      ...
      <section className="bg-[#F8F5F0] section-py relative">
        ...
        <div className="container-nrec relative max-w-5xl">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-gray-150 rounded-[28px] p-12 text-center shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
              <p className="text-gray-500 font-medium">No active notices available</p>
            </div>
          ) : (
